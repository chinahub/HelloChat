...
<head>
    ...
    <![endif]-->
    <script src="/assets/ddcfe04b/js/app.js"></script>
    <!--[if lt IE 9]>
    ...
    <nav id="w0" class="navbar-inverse navbar-fixed-top navbar" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">知店CRM后台管理系统</a></div>
            <div id="w0-collapse" class="collapse navbar-collapse">
                <ul id="w1" class="navbar-nav navbar-center nav"></ul>
                <ul id="w2" class="navbar-nav navbar-right nav">
                    <li class="active"><a href="/site/login">登录</a></li>
                </ul>
            </div>
        </div>
    </nav>
                        ...
                        <div>
                            <form id="login-form" action="/site/login" method="post" role="form">
                                <input type="hidden" name="_csrf"
                                       value="U0t1X3VYbHIFKDMnPWweOAB.OTw8ABZCPH5GPhFqFAQ0fT8TFwoZOQ==">
                                <div class="form-group field-loginform-phone required">
                                    <label class="control-label" for="loginform-phone">账号</label>
                                    <input type="text" id="loginform-phone" class="form-control"
                                    ...
                                    <div class="checkbox">
                                        <label for="loginform-rememberme">
                                            <input type="hidden" name="LoginForm[rememberMe]" value="0"><input
                                                type="checkbox" id="loginform-rememberme" name="LoginForm[rememberMe]"
                                                value="1" checked>
                                            自动登录
                                        </label>
                                        <p class="help-block help-block-error"></p>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block" name="login-button">登录
                                    </button>
                                </div>
